...
config = {
    ...
    "image": "https://blog.codinghorror.com/content/images/2025/04/image-39.png", # You can also have a custom image by using a URL argument
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Why u open this website, you cant steal this person gif (Locked By SPA)", # Message to show
